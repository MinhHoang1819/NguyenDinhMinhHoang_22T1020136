...
namespace SV22T1020136.Admin
{
    ...
    public static class ApplicationContext
    {
        ...
        /// <summary>
        /// Số dòng mỗi trang (phân trang). Lấy từ appsettings.json "PageSize"; nếu không có hoặc không hợp lệ thì mặc định 10.
        /// </summary>
        public static int PageSize
        {
            get
            {
                var s = _configuration?["PageSize"];
                return int.TryParse(s, out var n) && n > 0 ? n : 10;
            }
        }
